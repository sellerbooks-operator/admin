...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        try
        {
            ...
            Log("=== SellerBooks Operator startup ===");
    ...
    {
        if (e.ExceptionObject is Exception ex) LogException("AppDomain.UnhandledException", ex);
    }
    ...
    private static void ShowFatalError(Exception ex)
    {
        ...
        {
            MessageBox.Show(
                "SellerBooks Operator tidak dapat dijalankan.\n\nDetail error:\n" + ex.Message +
                "\n\nLog:\n" + LogFile,
                "SellerBooks Operator", MessageBoxButton.OK, MessageBoxImage.Error);
        }
        catch { }
    }
    ...
    private static void LogException(string context, Exception ex) => Log(context + ": " + ex);
}